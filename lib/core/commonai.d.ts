...
declare function SetStageVector2(x: number, y: number): void;
...
declare function SuicideOnVector2(seconds: number, p: player, x: number, y: number): void;
...
declare function SuicideOnVector2Ex(easy: number, med: number, hard: number, p: player, x: number, y: number): void;
