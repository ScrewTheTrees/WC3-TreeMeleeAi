...
declare var bj_FORCE_PLAYER: Record<number, force>
...
declare var bj_slotControl: Record<number, mapcontrol>
...
declare var bj_ghoul: Record<number, unit>
declare var bj_crippledTimer: Record<number, timer>
declare var bj_crippledTimerWindows: Record<number, timerdialog>
...
declare var bj_queuedExecTriggers: Record<number, trigger>
...
declare function AngleBetweenVector2s(locA: location, locB: location): number

declare function DistanceBetweenVector2s(locA: location, locB: location): number
...
declare function PlaySoundAtVector2BJ(soundHandle: sound, volumePercent: number, loc: location, z: number): void
...
declare function AddSpecialEffectTargetUnitBJ(attachVector2Name: string, targetWidget: widget, modelName: string): effect
...
declare function ModifyHeroSkillVector2s(whichHero: unit, modifyMethod: number, value: number): boolean

declare function UnitDropItemVector2BJ(whichUnit: unit, whichItem: item, x: number, y: number): boolean

declare function UnitDropItemVector2Loc(whichUnit: unit, whichItem: item, loc: location): boolean
...
declare function UnitUseItemVector2Loc(whichUnit: unit, whichItem: item, loc: location): boolean
...
declare function UnitDamageVector2Loc(whichUnit: unit, delay: number, radius: number, loc: location, amount: number, whichAttack: attacktype, whichDamage: damagetype): boolean
...
declare function RestoreUnitLocFacingVector2BJ(key: string, missionKey: string, cache: gamecache, forWhichPlayer: player, loc: location, lookAt: location): unit
...
declare function SaveGameCheckVector2BJ(mapSaveName: string, doCheckpointHint: boolean): void
...
declare function IsVector2BlightedBJ(where: location): boolean
...
declare function IssueVector2OrderLocBJ(whichUnit: unit, order: string, whichLocation: location): boolean
...
declare function GroupVector2OrderLocBJ(whichGroup: group, order: string, whichLocation: location): boolean
...
declare function SetUnitRallyVector2(whichUnit: unit, targPos: location): void
